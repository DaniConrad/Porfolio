          ...
          <ul className='flex'>
            <li className={`list relative list-none z-10 ${id === '1' ? "active" : ""}`} onMouseOver={handleMouseOver}>
              <a href="#" className='relative flex justify-center items-center flex-col text-center w-full'>
                <span className="icon relative block text-center text-2xl">
                  <ion-icon name="home-outline" id='1' className="bg-lig"/>
                </span>
                <span className="text absolute text-sm tracking-tighter opacity-0 font-medium">Home</span>
              </a>
            </li>
            <li className={`list relative list-none z-10 ${id === '2' ? "active" : ""}`} onMouseOver={handleMouseOver}>
              <a href="#" className='relative flex justify-center items-center flex-col text-center w-full'>
                ...
                <span className="text absolute text-sm font-normal text-xs tracking-tighter opacity-0">Mensaje</span>
              </a>
            </li>
            <li className={`list relative list-none z-10 ${id === '3' ? "active" : ""}`} onMouseOver={handleMouseOver}>
              <a href="#" className='relative flex justify-center items-center flex-col text-center w-full'>
                ...
                <span className="text absolute text-sm font-normal text-xs tracking-tighter opacity-0">Qr</span>
              </a>
            </li>
            <li className={`list relative list-none z-10 ${id === '4' ? "active" : ""}`} onMouseOver={handleMouseOver}>
              <a href="#" className='relative flex justify-center items-center flex-col text-center w-full'>
                ...
                <span className="text absolute text-sm font-normal text-xs tracking-tighter opacity-0">Camara</span>
              </a>
            </li>
            <li className={`list relative list-none z-10 ${id === '5' ? "active" : ""}`} onMouseOver={handleMouseOver}>
              <a href="#" className='relative flex justify-center items-center flex-col text-center w-full'>
                ...
                <span className="text absolute text-sm font-normal text-xs tracking-tighter opacity-0">Compras</span>
              </a>
            </li>
