...
const FooterMobile = () => {
  ...
  return (
    <div className='flex flex-wrap justify-center bg-black py-2'>
        <a href="mailto:danilagmuller@gmail.com?subject=Consulta%20desde%20la%20web&body=¡Hola%20Danila!%20me%20gustaría%20recibir%20información%20sobre%20"  className='mx-3' Target='_blank'>
